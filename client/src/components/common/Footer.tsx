      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 items-start">
          ...
          <div className='text-center'>
            <h2 className="text-3xl font-bold ">FarmRoots</h2>
          ...
          <div className='text-center'>
            ...
            <ul className="space-y-1">
              <li className="text-sm hover:text-gray-400"><a href="#">Fruits</a></li>
              <li className="text-sm hover:text-gray-400"><a href="#">Vegetables</a></li>
              <li className="text-sm hover:text-gray-400"><a href="#">Dairy Products</a></li>
              <li className="text-sm hover:text-gray-400"><a href="#">Bakery</a></li>
              <li className="text-sm hover:text-gray-400"><a href="#">Pantry Staples and more....</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-500 mt-8 pt-4">
          <p className="text-center text-sm">&copy; 2024 FarmRoots. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
